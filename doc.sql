...
(
  ...
  AUTO_INCREMENT = 1
  DEFAULT CHARSET = utf8mb4 COMMENT ='系统-用户信息';
...
(
  ...
  AUTO_INCREMENT = 1
  DEFAULT CHARSET = utf8mb4 COMMENT ='系统-附件';
...
(
  ...
  AUTO_INCREMENT = 1
  DEFAULT CHARSET = utf8mb4 COMMENT ='系统-用户配置';
...
(
  ...
  AUTO_INCREMENT = 1
  DEFAULT CHARSET = utf8mb4 COMMENT ='文档-文件夹';
...
(
  ...
  AUTO_INCREMENT = 1
  DEFAULT CHARSET = utf8mb4 COMMENT ='文档-文件内容';
...
(
  ...
  AUTO_INCREMENT = 1
  DEFAULT CHARSET = utf8mb4 COMMENT ='文档-文件收藏夹（暂时定位个人云文档，未使用，后续协作，分享之后再启用）';
